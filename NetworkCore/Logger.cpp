...
bool Logger::start(std::wstring file_path, std::wstring file_name)
{
    ...
    m_current_file_name = file_name + L"_" + std::to_wstring(m_current_time->tm_year + 1900) + std::to_wstring(m_current_time->tm_mon + 1) + std::to_wstring(m_current_time->tm_mday) + L"_" + std::to_wstring(m_file_counter);
